...
$script:ModuleVersion = (Import-PowerShellDataFile -Path "$($script:ModuleRoot)\ado.core.psd1").ModuleVersion

# Detect whether at some level dotsourcing was enforced
$script:doDotSource = Get-PSFConfigValue -FullName ado.core.Import.DoDotSource -Fallback $false
if ($ado.core_dotsourcemodule) { $script:doDotSource = $true }
...
$importIndividualFiles = Get-PSFConfigValue -FullName ado.core.Import.IndividualFiles -Fallback $false
if ($ado.core_importIndividualFiles) { $importIndividualFiles = $true }

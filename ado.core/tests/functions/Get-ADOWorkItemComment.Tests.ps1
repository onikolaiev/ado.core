Describe "Get-ADOWorkItemComment Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOWorkItemComment).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOWorkItemComment).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Get-ADOWorkItemComment).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOWorkItemComment).Parameters['Token']
		...
		It 'Should have the expected parameter WorkItemId' {
			$parameter = (Get-Command Get-ADOWorkItemComment).Parameters['WorkItemId']
		...
		It 'Should have the expected parameter CommentId' {
			$parameter = (Get-Command Get-ADOWorkItemComment).Parameters['CommentId']
			$parameter.Name | Should -Be 'CommentId'
			$parameter.ParameterType.ToString() | Should -Be System.Int32
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter IncludeDeleted' {
			$parameter = (Get-Command Get-ADOWorkItemComment).Parameters['IncludeDeleted']
		...
		It 'Should have the expected parameter Expand' {
			$parameter = (Get-Command Get-ADOWorkItemComment).Parameters['Expand']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOWorkItemComment).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOWorkItemComment).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Project -Token -WorkItemId -CommentId
		__AllParameterSets -Organization -Project -Token -WorkItemId -CommentId -IncludeDeleted -Expand -ApiVersion -ProgressAction
		#>
	}

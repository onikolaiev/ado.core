Describe "Add-ADOWorkItemComment Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Add-ADOWorkItemComment).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Add-ADOWorkItemComment).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Add-ADOWorkItemComment).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Add-ADOWorkItemComment).Parameters['Token']
		...
		It 'Should have the expected parameter WorkItemId' {
			$parameter = (Get-Command Add-ADOWorkItemComment).Parameters['WorkItemId']
		...
		It 'Should have the expected parameter Text' {
			$parameter = (Get-Command Add-ADOWorkItemComment).Parameters['Text']
		...
		It 'Should have the expected parameter Format' {
			$parameter = (Get-Command Add-ADOWorkItemComment).Parameters['Format']
			$parameter.Name | Should -Be 'Format'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Add-ADOWorkItemComment).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Add-ADOWorkItemComment).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Project -Token -WorkItemId -Text
		__AllParameterSets -Organization -Project -Token -WorkItemId -Text -Format -ApiVersion -ProgressAction
		#>
	}

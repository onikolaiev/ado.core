Describe "Get-ADOWitField Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOWitField).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOWitField).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOWitField).Parameters['Token']
		...
		It 'Should have the expected parameter FieldNameOrRefName' {
			$parameter = (Get-Command Get-ADOWitField).Parameters['FieldNameOrRefName']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Get-ADOWitField).Parameters['Project']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOWitField).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOWitField).Parameters['ProgressAction']

Describe "Update-ADOWorkItem Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Update-ADOWorkItem).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Update-ADOWorkItem).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Update-ADOWorkItem).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Update-ADOWorkItem).Parameters['Token']
		...
		It 'Should have the expected parameter Id' {
			$parameter = (Get-Command Update-ADOWorkItem).Parameters['Id']
		...
		It 'Should have the expected parameter ValidateOnly' {
			$parameter = (Get-Command Update-ADOWorkItem).Parameters['ValidateOnly']
			$parameter.Name | Should -Be 'ValidateOnly'
		...
		It 'Should have the expected parameter BypassRules' {
			$parameter = (Get-Command Update-ADOWorkItem).Parameters['BypassRules']
			$parameter.Name | Should -Be 'BypassRules'
			$parameter.ParameterType.ToString() | Should -Be System.Management.Automation.SwitchParameter
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter SuppressNotifications' {
			$parameter = (Get-Command Update-ADOWorkItem).Parameters['SuppressNotifications']
			$parameter.Name | Should -Be 'SuppressNotifications'
			$parameter.ParameterType.ToString() | Should -Be System.Management.Automation.SwitchParameter
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter Expand' {
			$parameter = (Get-Command Update-ADOWorkItem).Parameters['Expand']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Update-ADOWorkItem).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Update-ADOWorkItem).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -Id -Body
		__AllParameterSets -Organization -Project -Token -Id -Body -ValidateOnly -BypassRules -SuppressNotifications -Expand -ApiVersion -ProgressAction
		#>
	}

Describe "Get-ADOBoard Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOBoard).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOBoard).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Get-ADOBoard).Parameters['Project']
		...
		It 'Should have the expected parameter Id' {
			$parameter = (Get-Command Get-ADOBoard).Parameters['Id']
		...
		It 'Should have the expected parameter Team' {
			$parameter = (Get-Command Get-ADOBoard).Parameters['Team']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOBoard).Parameters['Token']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOBoard).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOBoard).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Project -Id -Token
		__AllParameterSets -Organization -Project -Id -Team -Token -ApiVersion -ProgressAction
		#>
	}

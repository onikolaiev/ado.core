Describe "Remove-ADOWorkItem Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-ADOWorkItem).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Remove-ADOWorkItem).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Remove-ADOWorkItem).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Remove-ADOWorkItem).Parameters['Token']
		...
		It 'Should have the expected parameter Id' {
			$parameter = (Get-Command Remove-ADOWorkItem).Parameters['Id']
		...
		It 'Should have the expected parameter Destroy' {
			$parameter = (Get-Command Remove-ADOWorkItem).Parameters['Destroy']
			$parameter.Name | Should -Be 'Destroy'
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Remove-ADOWorkItem).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Remove-ADOWorkItem).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Organization -Project -Token -Id -Destroy -ApiVersion -ProgressAction
		#>
	}

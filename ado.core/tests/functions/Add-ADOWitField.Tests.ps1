Describe "Add-ADOWitField Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Add-ADOWitField).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Add-ADOWitField).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Add-ADOWitField).Parameters['Token']
		...
		It 'Should have the expected parameter Body' {
			$parameter = (Get-Command Add-ADOWitField).Parameters['Body']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Add-ADOWitField).Parameters['Project']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Add-ADOWitField).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Add-ADOWitField).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -Body
		__AllParameterSets -Organization -Token -Body -Project -ApiVersion -ProgressAction
		#>
	}

Describe "Update-ADOWorkItemTag Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Update-ADOWorkItemTag).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Update-ADOWorkItemTag).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Update-ADOWorkItemTag).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Update-ADOWorkItemTag).Parameters['Token']
		...
		It 'Should have the expected parameter Tag' {
			$parameter = (Get-Command Update-ADOWorkItemTag).Parameters['Tag']
		...
		It 'Should have the expected parameter NewName' {
			$parameter = (Get-Command Update-ADOWorkItemTag).Parameters['NewName']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Update-ADOWorkItemTag).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Update-ADOWorkItemTag).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Project -Token -Tag -NewName
		__AllParameterSets -Organization -Project -Token -Tag -NewName -ApiVersion -ProgressAction
		#>
	}

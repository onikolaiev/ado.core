Describe "Remove-ADOWorkItemComment Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-ADOWorkItemComment).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Remove-ADOWorkItemComment).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Remove-ADOWorkItemComment).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Remove-ADOWorkItemComment).Parameters['Token']
		...
		It 'Should have the expected parameter WorkItemId' {
			$parameter = (Get-Command Remove-ADOWorkItemComment).Parameters['WorkItemId']
		...
		It 'Should have the expected parameter CommentId' {
			$parameter = (Get-Command Remove-ADOWorkItemComment).Parameters['CommentId']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Remove-ADOWorkItemComment).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Remove-ADOWorkItemComment).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Organization -Project -Token -WorkItemId -CommentId -ApiVersion -ProgressAction
		#>
	}

Describe "Get-ADOBoardList Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOBoardList).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOBoardList).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Get-ADOBoardList).Parameters['Project']
		...
		It 'Should have the expected parameter Team' {
			$parameter = (Get-Command Get-ADOBoardList).Parameters['Team']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOBoardList).Parameters['Token']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOBoardList).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOBoardList).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Organization -Project -Team -Token -ApiVersion -ProgressAction
		#>
	}

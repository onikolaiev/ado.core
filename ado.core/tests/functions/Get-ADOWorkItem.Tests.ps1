Describe "Get-ADOWorkItem Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOWorkItem).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOWorkItem).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Get-ADOWorkItem).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOWorkItem).Parameters['Token']
		...
		It 'Should have the expected parameter Id' {
			$parameter = (Get-Command Get-ADOWorkItem).Parameters['Id']
		...
		It 'Should have the expected parameter Fields' {
			$parameter = (Get-Command Get-ADOWorkItem).Parameters['Fields']
		...
		It 'Should have the expected parameter Expand' {
			$parameter = (Get-Command Get-ADOWorkItem).Parameters['Expand']
		...
		It 'Should have the expected parameter AsOf' {
			$parameter = (Get-Command Get-ADOWorkItem).Parameters['AsOf']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOWorkItem).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOWorkItem).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -Id
		__AllParameterSets -Organization -Project -Token -Id -Fields -Expand -AsOf -ApiVersion -ProgressAction
		#>
	}

Describe "Get-ADOBoardColumnList Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOBoardColumnList).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOBoardColumnList).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Get-ADOBoardColumnList).Parameters['Project']
		...
		It 'Should have the expected parameter Board' {
			$parameter = (Get-Command Get-ADOBoardColumnList).Parameters['Board']
		...
		It 'Should have the expected parameter Team' {
			$parameter = (Get-Command Get-ADOBoardColumnList).Parameters['Team']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOBoardColumnList).Parameters['Token']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOBoardColumnList).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOBoardColumnList).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Project -Board -Token
		__AllParameterSets -Organization -Project -Board -Team -Token -ApiVersion -ProgressAction
		#>
	}

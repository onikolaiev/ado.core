Describe "Get-ADOClassificationNodeRoot Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOClassificationNodeRoot).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOClassificationNodeRoot).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Get-ADOClassificationNodeRoot).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOClassificationNodeRoot).Parameters['Token']
		...
		It 'Should have the expected parameter Depth' {
			$parameter = (Get-Command Get-ADOClassificationNodeRoot).Parameters['Depth']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOClassificationNodeRoot).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOClassificationNodeRoot).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Project -Token
		__AllParameterSets -Organization -Project -Token -Depth -ApiVersion -ProgressAction
		#>
	}

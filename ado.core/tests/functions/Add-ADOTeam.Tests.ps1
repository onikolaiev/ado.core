Describe "Add-ADOTeam Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Add-ADOTeam).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Add-ADOTeam).Parameters['Organization']
		...
		It 'Should have the expected parameter ProjectId' {
			$parameter = (Get-Command Add-ADOTeam).Parameters['ProjectId']
		...
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Add-ADOTeam).Parameters['Name']
		...
		It 'Should have the expected parameter Description' {
			$parameter = (Get-Command Add-ADOTeam).Parameters['Description']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Add-ADOTeam).Parameters['Token']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Add-ADOTeam).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Add-ADOTeam).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -ProjectId -Name -Token
		__AllParameterSets -Organization -ProjectId -Name -Description -Token -ApiVersion -ProgressAction
		#>
	}

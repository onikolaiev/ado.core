Describe "Hide-ADOWorkItemTypeState Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Hide-ADOWorkItemTypeState).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Hide-ADOWorkItemTypeState).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Hide-ADOWorkItemTypeState).Parameters['Token']
		...
		It 'Should have the expected parameter ProcessId' {
			$parameter = (Get-Command Hide-ADOWorkItemTypeState).Parameters['ProcessId']
		...
		It 'Should have the expected parameter WitRefName' {
			$parameter = (Get-Command Hide-ADOWorkItemTypeState).Parameters['WitRefName']
		...
		It 'Should have the expected parameter StateId' {
			$parameter = (Get-Command Hide-ADOWorkItemTypeState).Parameters['StateId']
			$parameter.Name | Should -Be 'StateId'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter Hidden' {
			$parameter = (Get-Command Hide-ADOWorkItemTypeState).Parameters['Hidden']
			$parameter.Name | Should -Be 'Hidden'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Hide-ADOWorkItemTypeState).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Hide-ADOWorkItemTypeState).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -StateId -Hidden
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -StateId -Hidden -ApiVersion -ProgressAction
		#>
	}

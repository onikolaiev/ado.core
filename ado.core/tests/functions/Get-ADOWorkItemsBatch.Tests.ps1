Describe "Get-ADOWorkItemsBatch Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOWorkItemsBatch).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOWorkItemsBatch).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Get-ADOWorkItemsBatch).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOWorkItemsBatch).Parameters['Token']
		...
		It 'Should have the expected parameter Ids' {
			$parameter = (Get-Command Get-ADOWorkItemsBatch).Parameters['Ids']
		...
		It 'Should have the expected parameter Fields' {
			$parameter = (Get-Command Get-ADOWorkItemsBatch).Parameters['Fields']
			$parameter.Name | Should -Be 'Fields'
			$parameter.ParameterType.ToString() | Should -Be System.String[]
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter Expand' {
			$parameter = (Get-Command Get-ADOWorkItemsBatch).Parameters['Expand']
		...
		It 'Should have the expected parameter AsOf' {
			$parameter = (Get-Command Get-ADOWorkItemsBatch).Parameters['AsOf']
			$parameter.Name | Should -Be 'AsOf'
		...
		It 'Should have the expected parameter ErrorPolicy' {
			$parameter = (Get-Command Get-ADOWorkItemsBatch).Parameters['ErrorPolicy']
			$parameter.Name | Should -Be 'ErrorPolicy'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOWorkItemsBatch).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOWorkItemsBatch).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -Ids
		__AllParameterSets -Organization -Project -Token -Ids -Fields -Expand -AsOf -ErrorPolicy -ApiVersion -ProgressAction
		#>
	}

Describe "Get-ADOWorkItemQuery Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOWorkItemQuery).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOWorkItemQuery).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Get-ADOWorkItemQuery).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOWorkItemQuery).Parameters['Token']
		...
		It 'Should have the expected parameter Query' {
			$parameter = (Get-Command Get-ADOWorkItemQuery).Parameters['Query']
		...
		It 'Should have the expected parameter Depth' {
			$parameter = (Get-Command Get-ADOWorkItemQuery).Parameters['Depth']
		...
		It 'Should have the expected parameter Expand' {
			$parameter = (Get-Command Get-ADOWorkItemQuery).Parameters['Expand']
		...
		It 'Should have the expected parameter IncludeDeleted' {
			$parameter = (Get-Command Get-ADOWorkItemQuery).Parameters['IncludeDeleted']
		...
		It 'Should have the expected parameter UseIsoDateFormat' {
			$parameter = (Get-Command Get-ADOWorkItemQuery).Parameters['UseIsoDateFormat']
			$parameter.Name | Should -Be 'UseIsoDateFormat'
			$parameter.ParameterType.ToString() | Should -Be System.Management.Automation.SwitchParameter
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter Raw' {
			$parameter = (Get-Command Get-ADOWorkItemQuery).Parameters['Raw']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOWorkItemQuery).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOWorkItemQuery).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Organization -Project -Token -Query -Depth -Expand -IncludeDeleted -UseIsoDateFormat -Raw -ApiVersion -ProgressAction
		#>
	}

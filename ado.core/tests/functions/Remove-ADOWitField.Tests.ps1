Describe "Remove-ADOWitField Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-ADOWitField).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Remove-ADOWitField).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Remove-ADOWitField).Parameters['Token']
		...
		It 'Should have the expected parameter FieldNameOrRefName' {
			$parameter = (Get-Command Remove-ADOWitField).Parameters['FieldNameOrRefName']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Remove-ADOWitField).Parameters['Project']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Remove-ADOWitField).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Remove-ADOWitField).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Organization -Token -FieldNameOrRefName -Project -ApiVersion -ProgressAction
		#>
	}

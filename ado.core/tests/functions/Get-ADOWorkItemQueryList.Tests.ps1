Describe "Get-ADOWorkItemQueryList Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOWorkItemQueryList).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOWorkItemQueryList).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Get-ADOWorkItemQueryList).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOWorkItemQueryList).Parameters['Token']
		...
		It 'Should have the expected parameter Depth' {
			$parameter = (Get-Command Get-ADOWorkItemQueryList).Parameters['Depth']
		...
		It 'Should have the expected parameter Expand' {
			$parameter = (Get-Command Get-ADOWorkItemQueryList).Parameters['Expand']
		...
		It 'Should have the expected parameter IncludeDeleted' {
			$parameter = (Get-Command Get-ADOWorkItemQueryList).Parameters['IncludeDeleted']
		...
		It 'Should have the expected parameter Raw' {
			$parameter = (Get-Command Get-ADOWorkItemQueryList).Parameters['Raw']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOWorkItemQueryList).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOWorkItemQueryList).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Organization -Project -Token -Depth -Expand -IncludeDeleted -Raw -ApiVersion -ProgressAction
		#>
	}

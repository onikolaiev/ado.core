Describe "Update-ADOBoardColumnList Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Update-ADOBoardColumnList).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Update-ADOBoardColumnList).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Update-ADOBoardColumnList).Parameters['Project']
		...
		It 'Should have the expected parameter Board' {
			$parameter = (Get-Command Update-ADOBoardColumnList).Parameters['Board']
			$parameter.Name | Should -Be 'Board'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter Body' {
			$parameter = (Get-Command Update-ADOBoardColumnList).Parameters['Body']
		...
		It 'Should have the expected parameter Team' {
			$parameter = (Get-Command Update-ADOBoardColumnList).Parameters['Team']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Update-ADOBoardColumnList).Parameters['Token']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Update-ADOBoardColumnList).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Update-ADOBoardColumnList).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Project -Board -Body -Token
		__AllParameterSets -Organization -Project -Board -Body -Team -Token -ApiVersion -ProgressAction
		#>
	}

Describe "Remove-ADOTeam Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-ADOTeam).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Remove-ADOTeam).Parameters['Organization']
		...
		It 'Should have the expected parameter ProjectId' {
			$parameter = (Get-Command Remove-ADOTeam).Parameters['ProjectId']
		...
		It 'Should have the expected parameter TeamId' {
			$parameter = (Get-Command Remove-ADOTeam).Parameters['TeamId']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Remove-ADOTeam).Parameters['Token']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Remove-ADOTeam).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Remove-ADOTeam).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Organization -ProjectId -TeamId -Token -ApiVersion -ProgressAction
		#>
	}

Describe "Set-ADOProjectPropertieList Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Set-ADOProjectPropertieList).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Set-ADOProjectPropertieList).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Set-ADOProjectPropertieList).Parameters['Token']
		...
		It 'Should have the expected parameter ProjectId' {
			$parameter = (Get-Command Set-ADOProjectPropertieList).Parameters['ProjectId']
		...
		It 'Should have the expected parameter Body' {
			$parameter = (Get-Command Set-ADOProjectPropertieList).Parameters['Body']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Set-ADOProjectPropertieList).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Set-ADOProjectPropertieList).Parameters['ProgressAction']

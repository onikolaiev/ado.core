Describe "Get-ADOClassificationNode Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOClassificationNode).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOClassificationNode).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Get-ADOClassificationNode).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOClassificationNode).Parameters['Token']
		...
		It 'Should have the expected parameter StructureGroup' {
			$parameter = (Get-Command Get-ADOClassificationNode).Parameters['StructureGroup']
		...
		It 'Should have the expected parameter Path' {
			$parameter = (Get-Command Get-ADOClassificationNode).Parameters['Path']
		...
		It 'Should have the expected parameter Depth' {
			$parameter = (Get-Command Get-ADOClassificationNode).Parameters['Depth']
			$parameter.Name | Should -Be 'Depth'
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOClassificationNode).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOClassificationNode).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Project -Token -StructureGroup
		__AllParameterSets -Organization -Project -Token -StructureGroup -Path -Depth -ApiVersion -ProgressAction
		#>
	}

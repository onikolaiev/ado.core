Describe "Update-ADOWorkItemQuery Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Update-ADOWorkItemQuery).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Update-ADOWorkItemQuery).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Update-ADOWorkItemQuery).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Update-ADOWorkItemQuery).Parameters['Token']
		...
		It 'Should have the expected parameter Query' {
			$parameter = (Get-Command Update-ADOWorkItemQuery).Parameters['Query']
		...
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Update-ADOWorkItemQuery).Parameters['Name']
		...
		It 'Should have the expected parameter Wiql' {
			$parameter = (Get-Command Update-ADOWorkItemQuery).Parameters['Wiql']
		...
		It 'Should have the expected parameter QueryType' {
			$parameter = (Get-Command Update-ADOWorkItemQuery).Parameters['QueryType']
		...
		It 'Should have the expected parameter Columns' {
			$parameter = (Get-Command Update-ADOWorkItemQuery).Parameters['Columns']
		...
		It 'Should have the expected parameter SortColumns' {
			$parameter = (Get-Command Update-ADOWorkItemQuery).Parameters['SortColumns']
		...
		It 'Should have the expected parameter UndeleteDescendants' {
			$parameter = (Get-Command Update-ADOWorkItemQuery).Parameters['UndeleteDescendants']
			$parameter.Name | Should -Be 'UndeleteDescendants'
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Update-ADOWorkItemQuery).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Update-ADOWorkItemQuery).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Project -Token -Query
		__AllParameterSets -Organization -Project -Token -Query -Name -Wiql -QueryType -IsPublic -IsDeleted -Columns -SortColumns -UndeleteDescendants -ApiVersion -ProgressAction
		#>
	}

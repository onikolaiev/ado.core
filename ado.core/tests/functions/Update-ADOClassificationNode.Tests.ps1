Describe "Update-ADOClassificationNode Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Update-ADOClassificationNode).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Update-ADOClassificationNode).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Update-ADOClassificationNode).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Update-ADOClassificationNode).Parameters['Token']
		...
		It 'Should have the expected parameter StructureGroup' {
			$parameter = (Get-Command Update-ADOClassificationNode).Parameters['StructureGroup']
		...
		It 'Should have the expected parameter Path' {
			$parameter = (Get-Command Update-ADOClassificationNode).Parameters['Path']
		...
		It 'Should have the expected parameter Name' {
			$parameter = (Get-Command Update-ADOClassificationNode).Parameters['Name']
		...
		It 'Should have the expected parameter StartDate' {
			$parameter = (Get-Command Update-ADOClassificationNode).Parameters['StartDate']
		...
		It 'Should have the expected parameter FinishDate' {
			$parameter = (Get-Command Update-ADOClassificationNode).Parameters['FinishDate']
		...
		It 'Should have the expected parameter Attributes' {
			$parameter = (Get-Command Update-ADOClassificationNode).Parameters['Attributes']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Update-ADOClassificationNode).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Update-ADOClassificationNode).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Organization -Project -Token -StructureGroup -Path -Name -StartDate -FinishDate -Attributes -ApiVersion -ProgressAction
		#>
	}

Describe "Remove-ADOWorkItemTag Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-ADOWorkItemTag).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Remove-ADOWorkItemTag).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Remove-ADOWorkItemTag).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Remove-ADOWorkItemTag).Parameters['Token']
		...
		It 'Should have the expected parameter Tag' {
			$parameter = (Get-Command Remove-ADOWorkItemTag).Parameters['Tag']
		...
		It 'Should have the expected parameter PassThru' {
			$parameter = (Get-Command Remove-ADOWorkItemTag).Parameters['PassThru']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Remove-ADOWorkItemTag).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Remove-ADOWorkItemTag).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Project -Token -Tag
		__AllParameterSets -Organization -Project -Token -Tag -PassThru -ApiVersion -ProgressAction
		#>
	}

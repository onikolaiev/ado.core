Describe "Get-ADOTeamList Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOTeamList).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOTeamList).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOTeamList).Parameters['Token']
		...
		It 'Should have the expected parameter Mine' {
			$parameter = (Get-Command Get-ADOTeamList).Parameters['Mine']
		...
		It 'Should have the expected parameter Top' {
			$parameter = (Get-Command Get-ADOTeamList).Parameters['Top']
		...
		It 'Should have the expected parameter Skip' {
			$parameter = (Get-Command Get-ADOTeamList).Parameters['Skip']
		...
		It 'Should have the expected parameter ExpandIdentity' {
			$parameter = (Get-Command Get-ADOTeamList).Parameters['ExpandIdentity']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOTeamList).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOTeamList).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Organization -Token -Mine -Top -Skip -ExpandIdentity -ApiVersion -ProgressAction
		#>
	}

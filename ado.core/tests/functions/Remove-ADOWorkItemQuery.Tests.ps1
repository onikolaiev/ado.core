Describe "Remove-ADOWorkItemQuery Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-ADOWorkItemQuery).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Remove-ADOWorkItemQuery).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Remove-ADOWorkItemQuery).Parameters['Project']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Remove-ADOWorkItemQuery).Parameters['Token']
		...
		It 'Should have the expected parameter Query' {
			$parameter = (Get-Command Remove-ADOWorkItemQuery).Parameters['Query']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Remove-ADOWorkItemQuery).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter PassThru' {
			$parameter = (Get-Command Remove-ADOWorkItemQuery).Parameters['PassThru']
			$parameter.Name | Should -Be 'PassThru'
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Remove-ADOWorkItemQuery).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Organization -Project -Token -Query -ApiVersion -PassThru -ProgressAction
		#>
	}

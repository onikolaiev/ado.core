Describe "Invoke-ADOWiqlQueryByWiql Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Invoke-ADOWiqlQueryByWiql).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Invoke-ADOWiqlQueryByWiql).Parameters['Organization']
		...
		It 'Should have the expected parameter Project' {
			$parameter = (Get-Command Invoke-ADOWiqlQueryByWiql).Parameters['Project']
		...
		It 'Should have the expected parameter Team' {
			$parameter = (Get-Command Invoke-ADOWiqlQueryByWiql).Parameters['Team']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Invoke-ADOWiqlQueryByWiql).Parameters['Token']
		...
		It 'Should have the expected parameter Query' {
			$parameter = (Get-Command Invoke-ADOWiqlQueryByWiql).Parameters['Query']
		...
		It 'Should have the expected parameter TimePrecision' {
			$parameter = (Get-Command Invoke-ADOWiqlQueryByWiql).Parameters['TimePrecision']
		...
		It 'Should have the expected parameter Top' {
			$parameter = (Get-Command Invoke-ADOWiqlQueryByWiql).Parameters['Top']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Invoke-ADOWiqlQueryByWiql).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Invoke-ADOWiqlQueryByWiql).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -Query
		__AllParameterSets -Organization -Project -Team -Token -Query -TimePrecision -Top -ApiVersion -ProgressAction
		#>
	}

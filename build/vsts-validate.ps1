...
$modules = @("PowerShellGet", "PSFramework", "PSScriptAnalyzer", "PSNotification", "dbatools", "fscps.ascii")
...
& "$PSScriptRoot\..\ado.core\tests\pester.ps1" -TestGeneral $TestGeneral -TestFunctions $TestFunctions -Exclude $Exclude
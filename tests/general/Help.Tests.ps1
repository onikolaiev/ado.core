...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\ado.core\functions", "$global:testroot\..\ado.core\internal\functions"),
...
$CommandPath = @(
    "$global:testroot\..\ado.core\functions"
    "$global:testroot\..\ado.core\internal\functions"
)

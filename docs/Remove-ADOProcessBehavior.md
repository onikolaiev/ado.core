...
```
Remove-ADOProcessBehavior [-Organization] <String> [-Token] <String> [-ProcessId] <String>
 [-BehaviorRefName] <String> [[-ApiVersion] <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

...
```
Add-ADOWorkItemTypeGroup [-Organization] <String> [-Token] <String> [-ProcessId] <String>
 [-WitRefName] <String> [-PageId] <String> [-SectionId] <String> [-Body] <String> [[-ApiVersion] <String>]
